...
function Block({ label, text }: { label: LocalizedText; text: LocalizedText }) {
  const { t } = useLocale();
  ...
  return (
    ...
    >
      ...
      {covers.length > 0 ? (
        ...
        <div
          className="container-media flex flex-col"
          style={{
            ...
            <FadeUp key={cover.src}>
              <div className="w-full overflow-hidden rounded-md bg-surface">
                <Image
                  ...
                  quality={90}
                  sizes="(min-width: 1108px) 980px, 100vw"
        ...
        <FadeUp className="container-media">
          <div
